...
def get_columns():
	return [
		...
		{"fieldname": "attendance_deduction", "label": "Attendance Deduction", "fieldtype": "Currency", "width": 140},
		{"fieldname": "total_other_deduction", "label": "Other Deduction", "fieldtype": "Currency", "width": 140},
		{"fieldname": "total_deduction", "label": "Total Deduction", "fieldtype": "Currency", "width": 140},
	]
...
def get_data(filters):
	...
	data = frappe.db.sql(f"""
		SELECT 
			...
			(sp.attendance_deduction + sp.total_other_deduction) as total_deduction
